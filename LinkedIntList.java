...
public class LinkedIntList {
    ...
    //Mit første forsøg på at lave opg. 17. Brugte metodekald for at gøre opgaven let, men følte lidt at jeg snød ;-).
    //ch16_17 (halv-snyd)
        /*
        public void removeRange (int startIndex, int endIndex){
            ...
            if (startIndex<0 || endIndex<0){
                throw new IllegalArgumentException("The given indexes can't be below 0.");
            } else if (nodeAt(startIndex-1) != null && nodeAt(endIndex+1) != null){
                start = nodeAt(startIndex-1);
                end = nodeAt(endIndex+1);
                start.next = end;
            } else {
                throw new IllegalArgumentException("Either the node before the startIndex or the node after the endIndex is null.");
            }
        }
        */
